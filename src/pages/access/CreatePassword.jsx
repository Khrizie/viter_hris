...
import { apiVersion, devNavUrl, getUrlParam } from "../../functions/functions-general";
...
const CreatePassword = () => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(`${apiVersion}/controllers/developers/settings/users/set-password.php`, "post", values),
