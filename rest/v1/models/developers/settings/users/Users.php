...
class Users
{
    ...
    public function readLimit()
    {
        try {
            ...
            $sql .= $this->search != '' ? " and ( " : " ";
            $sql .= $this->search != '' ? " users_first_name like :users_first_name " : " ";
            $sql .= $this->search != '' ? "  or users_last_name like :users_last_name " : " ";
            $sql .= $this->search != '' ? "  or users_email like :users_email " : " ";
            $sql .= $this->search != '' ? " ) " : " ";
            $sql .= " limit :start, ";
            $sql .= " :total ";
            $query = $this->connection->prepare($sql);
