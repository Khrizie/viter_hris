...
CREATE TABLE `memo` (
  ...
  `memo_date` varchar(200) NOT NULL,
...
(1, 1, 'Jervie', 'Chloe', '2026-04-28', 'event', 'agasfasasf', '2026-04-27 08:16:43', '2026-04-27 08:16:43');
...
--
ALTER TABLE `memo`
  MODIFY `memo_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
